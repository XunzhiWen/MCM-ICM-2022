...
\begin{abstract}
 ...
 \textbf{ Differential Equations of Carbon Sink Value under Multi-Tree Species Competition},
  ...
  highest with \textbf{0.993638 (no-harvest)} and \textbf{0.98369 (harvest)}. 
  \par
  ...
  model to predict the intensity of competition. After that, by selecting and 
  ...
  whose gap from reality is merely $\bm{8.1\%}$.     
...
% In turn, the reduced number of trees 
% felled means less damage to the remaining standing trees around the felled 
% area (that is, the logging gap that trees can create when felled) and to the 
% vegetation between the nearest major logging road and the trees in order to 
% reach and harvest the latter. 
