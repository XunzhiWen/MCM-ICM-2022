...
\par
Carbon Sink includes the following indexes: Carbon Credit Benefit and Cost Analysis
(CVal), Wooden Product Proportion, Harvest Rate and Interspecific Competition, which
will exert influence on carbon sink in this Forest.
