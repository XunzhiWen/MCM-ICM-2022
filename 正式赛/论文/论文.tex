...
\begin{figure}[ht]
  ...
  \begin{minipage}[htbp]{0.55\linewidth}
    \begin{flushright}
      \includegraphics[width = 10cm]{code&pic/Roundwood cutting ways.pdf}
...
\begin{figure}[htbp]
  ...
  \subfigure[]{
  \centering
  \includegraphics[width = 0.46\textwidth]{code&pic/LivingTrees.eps}
  }
\quad
  \subfigure[]{
  \centering
  \includegraphics[width = 0.46\textwidth]{code&pic/proportion.eps}
  }
